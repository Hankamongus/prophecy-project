...
<link href="https://fonts.googleapis.com/css?family=Lato: 100,300,400,700|Luckiest+Guy|Oxygen:300,400" rel="stylesheet">
  ...
  <div class="flex -space-x-8 w-full">
        ...
        <div class="aspect-video w-full z-10 bg-center bg-cover filter grayscale hover:filter-none transition duration-500 transition duration-300 transform hover:scale-150 w-full h-full md:w-full md:h-md lg:w-full lg:h-full xl:w-full xl:h-full rounded-lg -ml-6 md:ml-0" style="background-image: url(https://research.lifeway.com/wp-content/uploads/2021/05/church_plant_closures.jpg)" />
    </div>
