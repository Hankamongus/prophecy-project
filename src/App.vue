...
<nav id="navbar" class="w-full left-0 right-0 mt-0 bg-gradient-to-r from-gray-400 via-sky-800 to-gray-400 dark:from-gray-800 dark:via-sky-800 dark:to-gray-800 fixed left-0 w-full z-30 top-0 mb-5 p-1 text-lg transition-transform duration-300 transform">
            <div class="hide-until-hover group font-bold text-white dark:text-black text-lg sm:text-xl md:text-3xl">Solid Rock Baptist<strong>▾</strong>
                <div class="flex justify-center hidden group-hover:block border-black border-4 rounded-lg h-auto w-28 bg-gray-500">
                    <ul class="text-lg">
