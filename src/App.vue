                        ...
                        <div class="mx-auto max-w-8xl px-2 sm:px-6 lg:px-812">
                            ...
                            <div class="relative flex h-16 items-center justify-between">
                                ...
                                >
                                    ...
                                    <li class="hover:bg-white roounded-lg">
                                        <div class="flex"><router-link to="prophecies" class="flex items-center space-x-1 text-red-800 hover:text-sky-700 mb-12"><p class="text-3xl border-b rounded-lg">Prophecies</p></router-link>▾</div>
                                    </li>
                                    <li class="hover:bg-white roounded-lg">
