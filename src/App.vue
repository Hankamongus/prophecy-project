    ...
    <nav id="navbar" class="w-full left-0 right-0 mt-0 bg-gradient-to-r from-gray-400 via-sky-800 to-gray-400 dark:from-gray-800 dark:via-sky-800 dark:to-gray-800 fixed left-0 w-full z-30 top-0 mb-5 p-1 text-lg transition-transform duration-300 transform">
        ...
        <div class="group flex flex-col items-center">
            ...
            <div id="contact" v-if="contactOpen" class="flex justify-center border-black border-4 rounded-lg h-auto w-28 bg-gray-500">
                <ul class="text-lg">
                    <li><a href="tel:2705272957" class="text-black hover:text-sky-700 hover:underline">Call</a>▾</li>
                    <li><a href="mailto:joyoconnell@outlook.com?subject=Contact Solid Rock" class="text-black hover:text-sky-700 hover:underline">Email</a>▾</li>
                    <li><a href="https://www.google.com/maps/place/The+Solid+Rock+Baptist+Church/@36.9297529,-88.3411535,17z/data=!3m1!4b1!4m6!3m5!1s0x887a42bc802dd477:0x3046b7e3359d6952!8m2!3d36.9297486!4d-88.3385786!16s%2Fg%2F11c380rcrx?entry=ttu" class="text-black hover:text-sky-700">Directions</a>▾</li>
                </ul>
            </div>
